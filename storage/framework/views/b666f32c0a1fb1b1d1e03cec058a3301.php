...
<body>
    ...
    <?php echo $__env->make('dashboard.organs.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<!-- partial -->
	
		<div class="page-wrapper">
					
			<!-- partial:partials/_navbar.html -->
			<?php echo $__env->make('dashboard.organs.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			<!-- partial -->
...
</html>    <?php /**PATH C:\xampp\htdocs\Tracking-Api\trackingApi\resources\views/dashboard/master.blade.php ENDPATH**/ ?>