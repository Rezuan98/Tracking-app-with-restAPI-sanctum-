<nav class="sidebar">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="emails">
            <ul class="nav sub-menu">
              <li class="nav-item">
                <a href="<?php echo e(route('add.marketer')); ?>" class="nav-link">Add Marketer</a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('all.marketer')); ?>" class="nav-link">All Markers</a>
              </li>
  ...
  </nav><?php /**PATH C:\xampp\htdocs\Tracking-Api\trackingApi\resources\views/dashboard/organs/sidebar.blade.php ENDPATH**/ ?>